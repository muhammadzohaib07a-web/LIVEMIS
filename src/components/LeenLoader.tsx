...
// loop, with a shimmering sweep underneath. Uses the app's own theme
// variables (bg-background, text-foreground, --color-primary) so it always
// matches the active theme with no SSR/hydration flash.
